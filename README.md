...
<!-- HUMAN/PHASE TODO: add demo-session link before final submission -->

A complete multi-turn session demonstration is required by
[`docs/final_evaluation_faq.md`](docs/final_evaluation_faq.md) §7 and is not yet
